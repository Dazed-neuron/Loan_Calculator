...
def create_greeting(friend_name, favorite_drink):
    ...
    the_string = 'Hello {friend_name}, I hope you are having a wonderful day! Would you like a glass of {favorite_drink}?'.format(friend_name=friend_name.capitalize(), favorite_drink=favorite_drink.capitalize())
    return the_string
